...
> ⚠️ **Status:** today the firmware drives the **incremental A/B/Z** path — the
> **Omron E6B2-CWZ6C** on the bench, which is what the ACC / AMS2 / EVO validation ran on.
> The **magnetic SPI** sensors are **in progress and not selectable yet**. Buy accordingly:
> a magnetic encoder is the better sensor, but it is not plug-and-play today.
...
| **Resolution** | 10000 CPR (0.036°) | 14-bit / 16384 (0.022°) | 14-bit / 16384 (0.022°) | ✅ **21-bit / 2097152 (0.00017°)** |
...
| **DriveLab support** | ✅ **Works today** | 🔧 In progress | 🔧 In progress | 🔧 In progress |
...
| **Resolução** | 10000 CPR (0,036°) | 14 bits / 16384 (0,022°) | 14 bits / 16384 (0,022°) | ✅ **21 bits / 2097152 (0,00017°)** |
...
| **Suporte no DriveLab** | ✅ **Funciona hoje** | 🔧 Em andamento | 🔧 Em andamento | 🔧 Em andamento |
