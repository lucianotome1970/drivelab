...
// ffb_task_start corrigir o scale.
...
static void rtos_main(void*) {
    ...
    // do real vbus (ex: 28V pra fonte 24V), antes do ffb_task_start ter
    ...
    // ffb_task_start creates HidFFB/EffectsCalculator and spawns 1 kHz thread
