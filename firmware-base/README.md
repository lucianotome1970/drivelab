# firmware-base — Wheelbase Direct-Drive (nosso firmware sobre a FOC do ODrive)
...
- [ ] **Stage 1** — build completo da base no nosso projeto (Makefile + override board_v3 + TinyUSB).
      Milestone: `firmware-base` compila um firmware ODrive-torque pro nosso board (v3.6-56V).
