// ============================================================================
//  DriveLab
//  FfbPlaybackView.axaml.cs — Code-behind de FfbPlaybackView (InitializeComponent).
//
...
public partial class FfbPlaybackView : UserControl
{
    public FfbPlaybackView() => InitializeComponent();
}
