...
{
    // clipping entra aqui pelo mesmo motivo que entrou no gráfico: ele só significa algo NO
    // CONTEXTO das outras colunas. Ver no vivo e não ter no arquivo seria pior — a análise
    // acontece depois, em cima do CSV.
    private static readonly string[] Columns =
        { "angle_deg", "torque", "current_mA", "bus_mV", "fet_C", "motor_C", "clipping_pct" };
