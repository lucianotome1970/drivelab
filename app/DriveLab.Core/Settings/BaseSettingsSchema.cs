...
public static class BaseSettingsSchema
{
    public static IReadOnlyList<SettingDescriptor> All { get; } = new List<SettingDescriptor>
    {
        ...
        new(BaseSettingId.EncoderType, "encoder_type", "Tipo de encoder (0=E6B2/ABI · 1=MT6701 · 2=AS5047P)", SettingType.UInt8, 0, 2, "", SettingTab.Hardware, 0,
            "O sensor de posição instalado no motor. Escolha o modelo que você comprou."),
        ...
        new(BaseSettingId.TorqueConstant, "torque_constant", "Constante de torque (Kt) — 0 = não medido", SettingType.Float, 0, 2, "Nm/A", SettingTab.Hardware, 0,
            "Quantos Nm o motor entrega por ampere. Serve só para o monitor estimar o torque — não muda a força. Zero significa 'não medido', e aí o torque estimado aparece como '—' em vez de mostrar um chute."),
