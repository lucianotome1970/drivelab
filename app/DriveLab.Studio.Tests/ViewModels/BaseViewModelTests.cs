...
public class BaseViewModelTests
{
    ...
    [Fact]
    public async Task TotalStrength_Marks_Pending_But_Does_Not_Write()
    {
        // Arrastar o controle NÃO reconfigura a placa (o motor pode estar armado);
        // quem envia é o "Salvar no controlador" do dashboard, via PushAsync.
    ...
    [Fact]
    public async Task PushAsync_Sends_TotalStrength_And_Clears_Pending()
    {
        var vm = New(out var transport);
        await transport.ConnectAsync();
        vm.TotalStrength = 60;
