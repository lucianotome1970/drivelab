...
public class EncoderCatalogTests
{
    ...
    {
        // O E6B2 e uma FAMILIA (100 a 2500 PPR, o numero esta no codigo do modelo): nao ha
        // resolucao de fabrica a cravar, a pessoa le a etiqueta e digita.
        Assert.Equal(0, EncoderCatalog.DefaultResolution(EncoderCatalog.E6b2, EncoderTech.Abz));
        Assert.False(EncoderCatalog.IsResolutionFixed(EncoderCatalog.E6b2, EncoderTech.Abz));
