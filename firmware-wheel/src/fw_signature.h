...
//  fw_signature.h — Assinatura embutida no binário (.uf2) do aro, usada pelo
//  host (app / check_fw_signature.py) pra validar que um arquivo de firmware
//  selecionado pra atualização por USB (UF2/BOOTSEL) realmente é um firmware
//  DriveLab e bate com o "kind" do dispositivo alvo.
